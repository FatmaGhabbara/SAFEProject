...
-- Combined: Core + Articles + Support System
...
CREATE TABLE `reactions` (
  ...
  `id_article` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `type_reaction` enum('like','love','support') NOT NULL,
  `date_creation` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `posts` (
  ...
  KEY `id_user` (`id_user`),
  KEY `status` (`status`),
  CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `responds` (
  `id_respond` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `responds_ibfk_1` FOREIGN KEY (`id_comment`) REFERENCES `comments` (`id_comment`) ON DELETE CASCADE,
  CONSTRAINT `responds_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Sample Ratings
INSERT INTO `ratings` (`user_id`, `rating`, `comment`, `suggestion`) VALUES
