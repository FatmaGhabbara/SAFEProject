...
require_once $_SERVER['DOCUMENT_ROOT'] . '/SAFEProject/model/user.php';
...
function getProfilePictureUrl($user) {
    ...
    if (!empty($photo) && $photo !== 'assets/images/default-avatar.png' && file_exists($_SERVER['DOCUMENT_ROOT'] . '/SAFEProject/view/frontoffice/assets/images/uploads/' . $photo)) {
        return '/SAFEProject/view/frontoffice/assets/images/uploads/' . htmlspecialchars($photo);
    }
    return '/SAFEProject/view/frontoffice/assets/images/default-avatar.png';
}
?>
