...
// Simuler une liste d'utilisateurs (à adapter selon votre système)
// Dans un cas réel, vous devriez récupérer les utilisateurs depuis la base de données
// qui ne sont pas déjà conseillers
?>
                    ...
                    <form id="counselorForm" action="../../../controller/support/admin_create_counselor.php" method="POST" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="user_id" name="user_id" required>
                                ...
                                <!-- Dans un cas réel, vous devriez récupérer dynamiquement les utilisateurs -->
                                <!-- Exemple statique pour démonstration -->
                                <option value="1">Dr. Jean Dupont (jean.dupont@example.com)</option>
                                <option value="2">Dr. Marie Martin (marie.martin@example.com)</option>
                                <option value="3">Dr. Pierre Bernard (pierre.bernard@example.com)</option>
                            </select>
