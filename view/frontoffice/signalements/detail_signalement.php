					...
					<div class="inner">
						<div class="detail-card">
							...
							<div class="action-links">
								<a href="<?= dirname(dirname($_SERVER['SCRIPT_NAME'])) . '/mes_signalements.php' ?>" class="action-link">← Retour à la liste</a>						<a href="modifier_signalement.php?id=<?= $signalement['id'] ?>" class="action-link edit-link">✏️ Modifier</a>						<a href="../index.php" class="action-link">➕ Nouveau signalement</a>
