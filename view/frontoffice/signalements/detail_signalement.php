...
<head>
    ...
    <title>Détails Signalement - SAFEProject</title>
    <style>
    ...
    <div class="container">
        <div class="detail-card">
            ...
            <div class="action-links">
                <a href="mes_signalements.php" class="action-link">← Retour à la liste</a>
                <a href="ajouter_signalement.php" class="action-link">➕ Nouveau signalement</a>
