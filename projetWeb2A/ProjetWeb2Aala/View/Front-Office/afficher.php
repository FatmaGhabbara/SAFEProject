...
<body>
    ...
    <div class="posts-container">
        ...
        <!-- Post 2 -->
        <div class="post-card">
            <h2 class="post-title">Nouveautés et mises à jour</h2>
            <p class="post-description">
                Découvrez les dernières fonctionnalités ajoutées à notre système. 
                Nous travaillons constamment pour améliorer votre expérience. 
                Partagez vos suggestions dans les commentaires !
            </p>
            <div class="post-meta">
                <span class="post-author">Par Équipe</span>
