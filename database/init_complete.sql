...
-- Table 1: counselors (Conseillers psychologiques)
...
-- Table 2: support_requests (Demandes de support)
...
-- Table 3: support_messages (Messages de suivi)
...
-- Insérer des conseillers de test
...
SELECT COUNT(*) as 'Tables créées' FROM information_schema.tables WHERE table_schema = DATABASE();
